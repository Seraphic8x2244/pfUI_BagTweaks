...
- Partially tested in-game: the 0.1.35+ toolbar redesign renders as expected overall; the 0.1.38 Eye/EyeOff visibility toggle artwork is confirmed fixed. Remaining interaction/edge-case checks are listed below. The legacy Quest override repair cannot currently be reproduced on the available clients.
