...
L.DELETE_PROMPT = "Delete \"%s\"? Items return to General."
L.ACCOUNT_WIDE = "Account Wide"
L.PER_CHARACTER = "Per Character"
L.SORTING = "Sorting: %s  >"

L.QUEST_TOOLTIP = "Default Quest Items - %s - click menu / drag header"
L.CATEGORY_TOOLTIP = "%s - %s - click menu / drag header"
L.GENERAL_TOOLTIP = "Click for category/sorting menu"
L.ADD_TO_CATEGORY = "Add to Category"
L.ADD_TO_CATEGORY_TOOLTIP = "Release/click to classify the selected item here"
...
L.BAGS = "Bags"
L.KEYS = "Keys"
L.EMPTY_CATEGORIES = "Empty Categories"
L.BUTTON = "Button"
